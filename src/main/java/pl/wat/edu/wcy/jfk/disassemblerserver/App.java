...
import pl.wat.edu.wcy.jfk.disassemblerserver.disassembler.CodeInterpreter;
import pl.wat.edu.wcy.jfk.disassemblerserver.disassembler.InstructionParser;
...
public class App {
    ...
    public static CodeInterpreter codeInterpreter;
    ...
    public static void main(String[] args) {
        ...
        String coder32path = "src/main/resources/files/coder32.html";
        InstructionParser instructionParser = new InstructionParser(coder32path);
        codeInterpreter = new CodeInterpreter(instructionParser.getInstructions());
